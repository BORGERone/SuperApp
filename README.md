...
<div align="center">
<sub>
Иллюстрации интерфейса в этом README — макеты, подготовленные для документации;<br>
сами скриншоты появятся позже (их можно заменить, сохранив имена файлов в <code>docs/images/</code>).<br>
