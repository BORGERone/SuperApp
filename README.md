...
<div align="center">
<sub>
Иллюстрации интерфейса в этом README — стилизованные макеты: вместо текста и данных<br>
на них мягкие «скелетон»-формы, а состав экранов повторяет реальный клиент.<br>
Настоящий скриншот можно подставить, сохранив имена файлов в <code>docs/images/</code>.<br>
