...
### 3. Доски задач (Tasks) - планируется
**Требуемая функциональность:**
- Список досок
- Kanban доски (todo, in progress, done)
...
- **Профили пользователей и права доступа:**
  ...
  - Роли: Admin (полные права), User (ограниченные права)
  - Управление правами доступа к доскам и задачам
  - Совместная работа над досками

**Технические решения:**
- Drag & Drop API или библиотека (react-dnd, etc.)
